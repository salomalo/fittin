...
try 
{
	...
	$providerToken = ucfirst(strtolower(htmlentities($request['provider'],ENT_COMPAT | ENT_HTML401, "UTF-8"))); //hybridauth requires providers be all lowercase with the first letter capitalized
