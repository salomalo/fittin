...
<div class="mm-report-container">
	...
	<div class="mm-graph-container">
		...
		<div id="rendered_report">
			...
			<?php echo $report->createVisualElement(MM_SalesByPaymentServiceReport::$SALES_BY_PAYMENT_SERVICE_REPORT_DATAGRID,array("start_date"=>$startDate,"end_date"=>$endDate,"include_rebills"=>"on"),"100%","100%"); ?>
			<div class="clear"></div>
		</div>
		<!--/#rendered_report-->
	</div>
