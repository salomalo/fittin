...
<div id="mm-form-container">
	...
	<tr>
		...
		<td><input type='text' id='mm-name' value='<?php echo $product->getName(); ?>' class="long-text"/></td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			<div id="mm-access-container">
				...
				<input id="mm-associated-access-membership" type="radio" name="associated-access" value="membership" onclick="mmjs.accessChangeHandler()" <?php echo ($associatedMembership->isValid() ? "checked" : ""); ?> <?php echo ($hasBeenPurchased || (count($membershipList) == 0)) ? "disabled" : ""; ?> /> Membership Level<?php echo ((count($membershipList) == 0)) ? "*" : ""; ?> &nbsp; 
				<input id="mm-associated-access-bundle" type="radio" name="associated-access" value="bundle" onclick="mmjs.accessChangeHandler()" <?php echo ($associatedBundle->isValid() ? "checked" : ""); ?> <?php echo ($hasBeenPurchased || (count($bundleList) == 0)) ? "disabled" : ""; ?> /> Bundle<?php echo ((count($bundleList) == 0)) ? "**" : ""; ?> &nbsp;
			</div>
