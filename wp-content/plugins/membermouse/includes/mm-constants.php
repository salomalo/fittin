...
//$centralServer = (isLocalInstall("localhost") || isLocalInstall("membermouse2.localhost") || isLocalInstall("wordpress.test"))?"https://hub.membermouse.com/index.php?q=/":"https://hub.membermouse.com/index.php?q=/";
//$centralServerUrl = (isLocalInstall("localhost")  || isLocalInstall("membermouse2.localhost") || isLocalInstall("wordpress.test"))?"https://hub.membermouse.com":"https://hub.membermouse.com";
//$centralServerPrettyUrl = (isLocalInstall("localhost")  || isLocalInstall("membermouse2.localhost") || isLocalInstall("wordpress.test"))?"https://hub.membermouse.com":"https://hub.membermouse.com";
